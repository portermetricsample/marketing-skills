...
git clone --depth 1 https://github.com/portermetricsample/marketing-skills /tmp/ms \
  ...
  && cp -r /tmp/ms/reporting/porter-gsc-dashboard ~/.claude/skills/ \
  && rm -rf /tmp/ms
```
...
1. Download [`porter-gsc-dashboard.skill`](porter-gsc-dashboard.skill)
...
To invoke it explicitly: `/porter-gsc-dashboard`
