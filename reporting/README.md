...
| [`ads-reporting/`](ads-reporting/) | The client-installable **paid-ads report** method — one multi-channel report (Meta · Google · TikTok · LinkedIn · Shopify) built with SUMAS: chat answer, hosted dashboard, or exec summary. Companion to the "How I build my ads report" class. Reports only (no campaign writes) | 🌱 v1 — grows with the class |
