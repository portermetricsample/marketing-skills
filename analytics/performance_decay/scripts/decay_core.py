"""
decay_core — shared trend math for the performance_decay skill.

Pure functions over a numeric weekly series. No globals, no I/O, no site
assumptions. Used by analyze.py (per-entity) and segment.py (hierarchical
roll-ups) so both classify with the EXACT same validated logic.
"""
import numpy as np
